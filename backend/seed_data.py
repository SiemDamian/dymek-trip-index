...
# BADGES
badges_data = [
    ("Pierwszy wyjazd", "Pierwszy wspólny wyjazd.", "trips_count", 1),
    ("5 wyjazdów", "Udział w co najmniej 5 wyjazdach.", "trips_count", 5),
    ("Wysoka frekwencja", "Frekwencja minimum 80%.", "attendance_percent", 80),
    ("Dobry wynik", "Trip Index minimum 50 punktów.", "score", 50),
    ("Legenda punktów", "Trip Index minimum 80 punktów.", "score", 80),
]
...
print("Gotowe. Dodano dane testowe i przeliczono statystyki.")
print("Hasło testowych użytkowników: test12345")